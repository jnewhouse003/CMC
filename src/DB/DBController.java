...
public class DBController 
{
	...
	public static void getUniversity(String university) 
	{
		...
		if (university == "School 1") {
			System.out.println(allSchools.get(School1));	
			
		}
		if (university == "School 2") {
			System.out.println(allSchools.get(School1));	
			
		}
		if (university == "School 3") {
			System.out.println(allSchools.get(School1));	
			
		}
		if (university == "School 4") {
			System.out.println(allSchools.get(School1));	
			
		}
		if (university == "School 5") {
			System.out.println(allSchools.get(School1));	
			
		}
		if (university == "School 6") {
			System.out.println(allSchools.get(School1));	
	...
	public ArrayList<University> findTopFive(String state, String control, int lowerExpense, int upperExpense,
		...
		for (int i = 0; i < 5; i++) {
			...
			foundSchools.add(allSchools.get(index));
			allSchools.remove(index);
